  ...
  <script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script> -->
    ...
    height: 80px;" alt="'.$routeLoc->tracking_id.'"/>';
             ...
             /*       echo "<td>".$routeLoc->merchant_order_num."</td>";
                    ...
                    echo "<td>"?>
                      @if(can_access_route('montrealinfo_route.detail',$userPermissoins))
                      <a href="{{backend_url('montreal/route/orders/trackingid/'.$routeLoc->sprint_id.'/details')}}" target='_blank' class='btn btn-warning btn-xs'>Detail</a>
                      @endif
                      <?php echo "</td>";
                    echo "</tr>";
                    $i++;               
