...
@section('inlineJS')
   ...
   $( function() {
    ...
    <script>
        ...
        $(function () {
            appConfig.set('yajrabox.ajax', '{{ route('montrealPickedUp.data') }}');
        ...
        @include('backend.montrealdashboard.montreal_cards')
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>{{ $title_name }} <small>Picked Up From Hub</small></h2>
                            @if(can_access_route('export_MontrealPickedUp.excel',$userPermissoins))
                            <div class="excel-btn" style="float: right">
                                <a href="{{ route('export_MontrealPickedUp.excel') }}"
