...
@section('title', 'Montreal Pickup From Hub')
        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Montreal Pickup From Hub Order <small></small></h2>
                                ...
                                {{-- <div class="profile_img">
                                     <div id="crop-avatar">
                                         ...
                                         <ul class="main-image" style="list-style: none;">
                                             <li class="col-md-12">
                                                 <a class="group1">
                                                     <img class="img-responsive avatar-view" src="{{ URL::to('/') }}/public/images/profile_images/{{$amazon_montreal->image}}" style="    margin-left: -46px;" class="avatar" alt="Avatar"/>
                                                 </a>
                                             </li>
                                         </ul>
                            ...
                            <div class="col-md-10 col-sm-10 col-xs-12">
                                ...
                                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                    <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                        <li role="presentation" class="active"><a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">Amazon Montreal Pickup From Hub Order</a>
                                        </li>
                                    ...
                                    <div id="myTabContent" class="tab-content">
                                        <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                                            ...
                                            <table class="table table-bordered">
                                                <thead>
                                                <tr>
                                                    <th colspan="2" >Montreal Pickup From Hub Order</th>
                                                </tr>
                                                </thead>
                                                <tbody>
                                                <tr>
                                                    ...
                                                    <td><label>Image</label></td>
                                                     <td>
                                                        @if($amazon_montreal->image)
                                                            <img onClick="ShowLightBox(this);" src="{{$amazon_montreal->image}}" width="200" height="200" alt="{{$amazon_montreal->order_id}}"/>
                                                        @else
                                                        @endif
                                                    </td>
                                                </tr>
