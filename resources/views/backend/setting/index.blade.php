...
@section('inlineJS')
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '.form-delete', function(e){
                ...
                $.confirm({
                    title: 'A secure action',
                    content: 'Are you sure you want to delete Setting Sorter ??',
                    icon: 'fa fa-question-circle',
                    animation: 'scale',
                    closeAnimation: 'scale',
                    opacity: 0.5,
    ...
    <script>
        ...
        $(function () {
            appConfig.set('yajrabox.ajax', '{{ route('setting.data') }}');
            ...
            appConfig.set('yajrabox.columns', [
                ...
                {data: 'sorting_time',   orderable: true,   searchable: true,className: 'text-center'},
                {data: 'pickup_time',   orderable: true,   searchable: true,className: 'text-center'},
               // {data: 'delivery_time',   orderable: true,   searchable: true,className: 'text-center'},
                         ...
                         @include( 'backend.layouts.notification_message' )
                            ...
                            <table class="table table-striped table-bordered yajrabox" >
                                ...
                                <tr>
                                    ...
                                    <th style="width: 50%">Hub </th>
                                    <th style="width: 15%;text-align: center">Sorting Time </th>
                                    <th style="width: 15%;text-align: center">PickUp Time  </th>
                                    <{{--th style="width: 15%;text-align: center">Delivery Time</th>--}}
