                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            <form id="filter"
                                  action="" method="get">
                                <div class="col-lg-3">
                                    <input id="date" style="margin-bottom: 10px;" name="date" style="" type="date" placeholder="date "
                                       value='{{$date}}' class="form-control1">
                                </div>
                                <div class="col-lg-3">
                                    <button id="search" type="submit" class="btn green-gradient">Filter dsaddsd</button>
                                </div>
                            </form>
                        ...
                        <div class="x_content">
                            ...
                            <div class="table-responsive">
                                <table id="datatable" class="table table-striped table-bordered">
                                    ...
                                    @else
                                        {{--*/ $i = 1 /*--}}
                                        @foreach( $fistMileJobs as $record )
                                            <tr class="">
                                                <td>{{ $i }}</td>
                                                <td>{{ $record->job_id }}</td>
                                                <td>
...
{{--                                                        @if(can_access_route(['ctc-job.createCustom-route'],$userPermissoins))--}}
                                                            <button type='button'
                                                                    class='createCustom btn  green-gradient actBtn '
                                                                    data-id="{{$record->job_id}}" data-engine="{{ $record->engine }}">Create Route <i
                                                                        class='fa fa-eye'></i></button>
{{--                                                        @endif--}}
{{--                                                        @if(can_access_route(['ctc-job.create-route'],$userPermissoins))--}}

                                                    @elseif($record->status!='finished'&& $record->is_custom_route!='1')

                                                            <button type='button'
                                                                    class='create btn  green-gradient actBtn '
                                                                    data-id="{{$record->job_id}}">
                                                                Create Route <i
                                                                        class='fa fa-eye'></i></button>
{{--                                                        @endif--}}
                                                    @endif
{{--                                                    @if(can_access_route(['ctc-job.routific-job-delete'],$userPermissoins))--}}
                                                        <button type='button' class='delete btn  red-gradient actBtn '
                                                                data-id="{{$record->id}},{{$record->engine}}">Delete <i
            ...
            $(".createRouteByJobId").click(function () {
                ...
                if(routeEngine != ''){
                    ...
                    if(routeEngine == 1){ // engine 1 is routific
                        ...
                        url = '../../../beta/ctc/returncreateCustom/'+jobId+'/route';
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            // bootprompt.alert('Route Created Successfully');
                            ...
                            // window.location.href = "../../../../backend/ctc/routific/17/job";
                        },
