            ...
            @endif
                <div class="page-title">
                    <div class="title_left amazon-text">
                        <h3>First Mile Hub Store List<small></small></h3>
                    </div>
                </div>
...
{{--            <div class="clearfix"></div>--}}
            ...
            <div class="row">
                <div class="notifiedBox">
                    <h3>Note</h3>
                    <p>
                        This screen uses for see connected stores details,their orders counts,first mile slots details and creation of first mile routes.
                    </p>
                </div>
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panell">
                        <div class="">
                            ...
                            ?>
                                <div class="col-md-6 exportBtnn">
                                    <a href="{{ url('first/mile/routes/list') }}" class="btn btn green-gradient" data-id="25" >First Mile Routes List 
                                         <i class="fa fa-list-alt"></i>
                                    </a>
                                </div>
                                <div class="col-md-6 btn_col" style="padding:0; display: flex; justify-content: end;">
                                    ...
                                    <button type='button' class='counts btn btn orange-gradient actBtn'
                                            data-id='{{$id}}'>Total Store Orders Count  <i class='fa fa-eye'></i>
                                    </button>

                                    <button type='button' class='route btn btn black-gradient actBtn'
                                            data-id='{{$id}}'>Submit For Route <i class='fa fa-eye'></i>
                                    </button>

                                    <a href='{{ url('first/mile/slots/list/hub_id/'. $id) }}'
                                       class='btn btn orange-gradient actBtn'> View First Mile Riders Slots <i
                                                class='fa fa-eye'></i></a>
                                </div>
                                <div class="clearfix"></div>
                        </div>
                        ...
                        <div class="x_content">
                            ...
                            <div class="table-responsive">
                                ...
                                <table id="datatable" class="table table-striped table-bordered">
                                    ...
                                    <tr>
                                        <th style="width: 11%;">Vendor Id</th>
                                        <th style="width: 11%;">Vendor Title</th>
                                        <th style="width: 11%;">Vendor Address</th>
                                        <th style="width: 11%;">Vendor Order Count</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    ...
                                    @php
                                        ...
                                        if($vendor->business_address == null){
                                            ...
                                            if($location){
                                                ...
                                                $locationEnc = \App\LocationEnc::find($vendor->location_id);
                                    ...
                                    @endphp
                                        <tr>
                                            ...
                                            <td>{{ $vendor->name }}</td>
                                            <td>{{ $address }}</td>
                                            <td>{{ $vendor->getVendorOrdersCount(date("Y-m-d", strtotime($date))) }}</td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                                </table>
    ...
    <div id="ex10" class="modal" style="display: none">
        <div class='modal-dialog'>
            <div class='modal-content'>
                ...
                <form action='../routes/store' method='post' class='submitForRoute'>
...
{{--                    <a class="btn black-gradient" data-dismiss="modal" aria-hidden="true">Close</a>--}}
                    ...
                    <h4 style="text-align: -webkit-center;font-size: x-large;" id="count_detail" class="modal-title">
                        Count Details</h4>
                </div>
                <span class="popRow">
                ...
                <span class="c-popRow">
                    <a type='button' id="aaa" style="margin-top:10px;width: 168px;"
                       class='route btn btn black-gradient actBtn' data-id='17'>Submit For Route <i class='fa fa-eye'></i></a>
                </span>
            </div>
        </div>
    </div>
...
{{--    </script>--}}
    ...
    <script type="text/javascript">
        ...
        // close modal function on click 2022-05-19
...
//    var element = $(this);
            ...
            $(".counts").click(function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $('#slots_detail').html(x);
                        $('#ex20').find('#aaa').attr('data-id', hub_id);
                        // $('#ex20').modal();
    ...
    <script type="text/javascript">
        ...
        $('.submitForRoute').submit(function (event) {
            ...
            data.append('create_date', $('#date').val());
