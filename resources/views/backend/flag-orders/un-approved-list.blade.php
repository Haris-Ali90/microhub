...
@section('title', 'Un Approved Flag List')
...
@section('inlineJS')
    ...
    <script type="text/javascript">
        ...
        function getExportFileName() {
            ...
            return 'Un Approved Flag List '+filter_start_date+" to "+filter_start_end;
        ...
        $DataTable = $('.flag-orders-table').DataTable({
            ...
            processing: true,
            ajax: {
                url: '{{ route('un-approved-flag-list.data') }}',
                data: function(data) {
...
//            Object.getPrototypeOf($DataTable).DataTable
        ...
        {{--$(function () {--}}
            ...
            {{--appConfig.set('yajrabox.ajax', '{{ route('flag-order-list.data') }}');--}}
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h3>Un Approved Flag Orders<small></small></h3>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Un Approved Flag Orders List</h2>
