...
@section('inlineJS')
    ...
    <script>
        ...
        $(function () {
            appConfig.set('yajrabox.ajax', '{{ route('newottawaPickedUp.data') }}');
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h3 class="text-center">{{ $title_name }} Out For Delivery<small></small></h3>
                </div>
            </div>
        ...
        @include('backend.newottawadashboard.ottawa_cards')
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>{{ $title_name }} Out For Delivery</small></h2>
                            @if(can_access_route('newexport_OttawaPickedUp.excel',$userPermissoins))
                            <div class="excel-btn" style="float: right">
                                <a href="{{ route('newexport_OttawaPickedUp.excel') }}"
                            ...
                            <form method="get" action="">
                                <div class="row">
                                    <div class="col-md-3">
                                        ...
                                        <input type="hidden" name="type" value="picked" id="type">
                                    </div>
