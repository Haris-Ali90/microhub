...
@section('inlineJS')
    ...
    <script>
        ...
        $(function () {
            appConfig.set('yajrabox.ajax', '{{ route('newottawaNotReturned.data') }}');
            ...
            appConfig.set('yajrabox.columns', [
                ...
                {data: 'picked_up_at',   orderable: true,   searchable: true, className:'text-center'},
                {data: 'sorted_at',   orderable: true,   searchable: true, className:'text-center'},
     ...
     /*   $('.buttons-reload').on('click',function(event){
            ...
            showLoader();
            var ref = $('#yajra-reload').DataTable();
            $("#ottawaCards").load(window.location.href + " #ottawa-dashboard-tiles-id" ,function(){
                ref.ajax.reload(function(){
                    // hide loader
                    hideLoader()
                });
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h3 class="text-center">{{ $title_name }} Returned Order<small></small></h3>
                </div>
            </div>
        ...
        <!--Count Div Row Close-->
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>{{ $title_name }} Returns Not Received At Hub</small></h2>
                            @if(can_access_route('newexport_OttawaNotReturned.excel',$userPermissoins))
                            <div class="excel-btn" style="float: right">
                                <a href="{{ route('newexport_OttawaNotReturned.excel') }}"
                                   class="btn buttons-excel buttons-html5 btn-sm btn-primary excelstyleclass">
                                    Export to Excel
                                </a>
                            </div>
                            @endif
                            @if(can_access_route('newexport_OttawaNotReturned_tracking.excel',$userPermissoins))
                                <div class="excel-btn" style="float: right">
                                    <a href="{{ route('newexport_OttawaNotReturned_tracking.excel') }}"
                                       class="btn buttons-excel buttons-html5 btn-sm btn-primary excelstyleclass">
