...
@section('inlineJS')
    ...
    <script>
        ...
        $(function () {
            appConfig.set('yajrabox.ajax', '{{ route('newottawaCustomRoute.data') }}');
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h3 class="text-center">{{ $title_name }} Custom Route Order<small></small></h3>
                </div>
            </div>
        ...
        <!--Count Div Row Close-->
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>{{ $title_name }} Custom Route Order</small></h2>
                            @if(can_access_route('newexport_OttawaCustomRoute.excel',$userPermissoins))
                            <div class="excel-btn" style="float: right">
                                <a href="{{ route('newexport_OttawaCustomRoute.excel') }}"
