...
@section('inlineJS')
    ...
    <script>
        ...
        $(function () {
            appConfig.set('yajrabox.ajax', '{{ route('newottawaNotScan.data') }}');
        ...
        <!--Count Div Row Close-->
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>{{ $title_name }} Not Scanned Orders</small></h2>
                            @if(can_access_route('newexport_OttawaNotScan.excel',$userPermissoins))
                            <div class="excel-btn" style="float: right">
                                <a href="{{ route('newexport_OttawaNotScan.excel') }}"
