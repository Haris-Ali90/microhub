...
@section('content')
    <div class="right_col" role="main">
        ...
        <div class="">
            ...
            <div class="row"><!---row-->
                       ...
                       <div class="col-lg-6">
                       <h1 ><b>Custom Routing  </b> </h1>
                       </div>
                       <div class="col-lg-6">
                       <button   style="background-color: #c6dd38;position: absolute;right: 0px;" data-id='{{$id}}'class='btn green-gradient btn clearOrder' >Clear Order </button>
                       </div>
                         ...
                         <div class="x_title">
                            ...
                            <div class="col-md-6 col-sm-6 trackID" >
                                <div class="col-md-4 col-sm-4 trackID">
                                    <input id="trackID" name="trackID" type="text"  placeholder='Tracking id....'  onchange="myFunction(this.value)" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6 c_date d-flex justify-content-end">
                                ...
                                <div class="col-md-6 col-sm-12 c_date">
                                    <label class="lable_text">Please Select The Date Before Scanning The Tracking Id</label>
    ...
    <div class="loader-iner-warp">
                        <div class="loader" style="display: none" ></div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th>Action </th>
                                                                ...
                                                                <!-- <td><input type="number" name="joey_capacity" value=1 min=1></td>  -->
                                                                 <td> <button   style="background-color: #c6dd38;" class='btn btn createRoute  green-gradient' >Create Job Id </button> </td>
                          ...
                          <div class="col-lg-6">
                          <h2> <b>Joeys Vehicle Detail </b></h2>

                          </div>
                          <div class="col-lg-6 d-flex justify-content-end">
                            <button style="background-color: #c6dd38; margin-top: 15px;" class='btn green-gradient btn addRow'>Add Joey Vehicle</button>
                            </div>
                           ...
                           <div class="x_content">
									...
									<div class="table-responsive" style="overflow-x: unset;">
                                                ...
                                                <?php 
                                                    ...
                                                    foreach($joey_route_detail as $data)
                                                    {
                                                        ...
                                                        echo "<td><button style='background-color: #c6dd38;' class='btn btn editrow' data-id='".$data->id."' >Edit</button><button data-id='".$data->id."' style=' background: #e46d28;' class='btn btn removerow'>Remove</button></td>";
                                                        echo "</tr>";
                                ...
                                <div class="x_title">   <!---x_title-->
                           <h2><br> <b>Scanned Order Details </b></h2>
                            ...
                            <div class="x_title">   <!---x_title-->
                                  ...
                                  <div class="col-lg-6  d-flex justify-content-end">
                                  <button type="button" class="btn btn-success green-gradient btn-md"  >Delete Record</button>
                                  </div>
                                       <div class="clearfix">  <!---clearfix-->
                                    ...
                                    <!---x_content start-->
                                            @include( 'backend.layouts.notification_message' )
                                                ...
                                                @php (array_push($tracking_ids,$data->tracking_id))
                                                    <td><button data-id='{{$data->tracking_id}}' style='background-color: #c6dd38;' class='btn btn edit'>Edit</button> <button data-id='{{$data->tracking_id}}' class='btn btn  remove' style=' background: #e46d28;'>Remove</button></td>        
                                                @elseif($data->valid_id==2)
                                                <td><button data-id='{{$data->tracking_id}}' style='background-color: #c6dd38;' class='btn btn reattempt'>Create reattempt</button> <button data-id='{{$data->tracking_id}}' class='btn btn  remove' style=' background: #e46d28;'>Remove</button></td>        
                                                @elseif($data->valid_id==3)
                                                <td><button data-id='{{$data->tracking_id}}' style='background-color: #c6dd38;' class='btn btn updateStatus'>Update Status</button> <button data-id='{{$data->tracking_id}}' class='btn btn  remove' style=' background: #e46d28;'>Remove</button></td>        
                                                ...
                                                <td> <button data-id='{{$data->tracking_id}}' class='btn btn  mark_return_merchant' style=' background: #c6dd38;'>Return To Merchant</button></td>        
                                                                
                                                @else
                                                     <td><button data-id='{{$data->tracking_id}}' style='background-color: #c6dd38;' class='btn btn btn-primary createOrder sub-ad'>Create</button> <button data-id='{{$data->tracking_id}}'  class='btn btn sub-ad remove' style='background: #e46d28; margin-left:2px !important'>Remove</button></td>         
  ...
  <form action="{{ URL::to('custom/create/order')}}" method="post" class="Editorder">
    <div class="modal-dialog">
  ...
  <form action="{{ URL::to('custom/create/order')}}" method="post" class="addRouteDetail">
    <div class="modal-dialog">
     ...
     <div class="modal-footer">
    <button type="submit" style='background-color: #3287FB; color:white; margin-top: 10px;' class="btn btn">Add Joey Vehicle</button>
    </div>
        </div>
  ...
  <form action="{{ URL::to('custom/create/order')}}" method="post" class="editRouteDetail">
    <div class="modal-dialog">
     ...
     <div class="modal-footer">
    <button type="submit" style='background-color: #c6dd38; margin-top: 10px;' class="btn btn">Edit Joey Vehicle</button>
    </div>
        </div>
  ...
  <form action="" method="post" class="reattemptOrder">
    <div class="modal-dialog">
     ...
     <div class="modal-footer">
         ...
         <!-- <button type="button" class="btn btn-secondary btn-default sub-ad bootprompt-cancel" data-dismiss="modal">Cancel</button> -->
...
function initialize() {
     ...
     $(document).on('click','.clearOrder',function(){
        ...
        bootprompt.confirm({
            ...
            if(result)
            {
                ...
                $.ajax({
              type: "post",
              url: "{{ URL::to('remove/order/inroute')}}",
    ...
    $(document).on('click','.createRoute',function(){
     ...
     //   alert('dd');
       ...
       $.ajax({
              type: "post",
              url: "{{ URL::to('create/route/custom/routing')}}",
              data:{hub_id:hub_id},
              beforeSend: function (request) {
                        return request.setRequestHeader('X-CSRF-Token',"{{ csrf_token() }}");
                    },
    ...
    $(".btn-success").click(function(){
        ...
        if (id.length > 0) {
            if (confirm("Are you sure want to delete this records")) {
                $.ajax({
                    url: "{{ URL::to('remove/multipletrackingid')}}",
                    type: "POST",
                    cache:false,
                    data:{deleteId:id},
                    beforeSend: function (request) {
...
$(document).on('click','.mark_return_merchant',function(){
    ...
    if(result)
    {
        $.ajax({
              type: "post",
              url: "{{ URL::to('trackingid/retuned/metchant')}}",
...
$.ajax({
    ...
    event.preventDefault();
        ...
        $.ajax({
                    type: "post",
                    url: "{{ URL::to('update/status/create/reattempt')}}",
...
$('.Createorder').submit(function(event) {
    ...
    $(".loader").show();
                        ...
                        $.ajax({
                                    url: "{{ URL::to('custom/create/order')}}",
                                    type: 'POST',
                                    contentType: false,
                                    processData: false,
                                    data:data,
...
$('.addRouteDetail').submit(function(event) {
   ...
   event.preventDefault();
                       ...
                       $.ajax({
                                   url: "{{ URL::to('custom/add/joey/count')}}",
                                   type: 'POST',
                                   contentType: false,
                                   processData: false,
                                   data:data,
...
$('.editRouteDetail').submit(function(event) {
   ...
   event.preventDefault();
                       ...
                       $.ajax({
                                   url: "{{ URL::to('custom/edit/joey/count')}}",
                                   type: 'POST',
                                   contentType: false,
                                   processData: false,
                                   data:data,
