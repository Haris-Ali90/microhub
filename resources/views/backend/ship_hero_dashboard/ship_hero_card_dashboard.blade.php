...
@section('title', 'Shiphero Statistics')
...
@section('inlineJS')
    ...
    <script>
        ...
        function getTotalOrderData() {
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo URL::to('/'); ?>/ship-hero/totalcards/" + selected_date + "/" + type,
                data: {},
                success: function (data) {
                    ...
                    $('#reattempted_orders').text(data['boradless_count']['reattempted']);
        ...
        function getInProgressOrdersData() {
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo URL::to('/'); ?>/ship-hero/inprogress/" + selected_date + "/" + type,
                data: {},
                success: function (data) {
        ...
        function getCustomRouteData() {
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo URL::to('/'); ?>/ship-hero/customroutecards/" + selected_date,
                data: {},
                success: function (data) {
        ...
        function getYesterdayOrderData() {
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo URL::to('/'); ?>/ship-hero/yesterdaycards/" + selected_date,
                data: {},
                success: function (data) {
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left amazon-text">
                    <h3 class="text-center">Shiphero Statistics
                        <small></small>
                    </h3>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>
                                <small>Shiphero Statistics</small>
                            </h2>
                        ...
                        <div class="x_content">
                            ...
                            @include('backend.ship_hero_dashboard.ship_hero_cards')
                        </div>
                    </div>
                </div>
