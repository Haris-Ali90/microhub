...
@section('content')
    <!--right_col open-->
    <div class="page-content-wrapper cutomMainbox_us" style="min-height:1100px !important; margin-left: 0 !important;">
        <section class="progress_sec" style="padding-top: 50px">

            <h1 class="lh-10">Documents</h1>
            <div class="container">
                <div role="progressbar" aria-valuenow="67" aria-valuemin="0" aria-valuemax="100" style="--value: 75"></div>
            </div>
        </section>
...
{{--                        <h1 class="lh-10">Documents</h1>--}}
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        <form method="post" action="../microhub/newdocument/save" id="document-form" class="needs-validation"
                            ...
                            @foreach($documentTypes as $doc)
                                ...
                                @endif
                            @endforeach
                            <div class="content_footer_wrap next_page">
                                <a href="{{url('microhub/newtraining')}}" class="next_btn">NEXT</a>
                            </div>
                        </form>
                    </div>
