...
<table id="export-csv" class="table table-striped table-bordered" border="1">
                ...
                <tbody>
                    ...
                    foreach($fullrecord as $record) { 
                        ...
                        <tr>
                            ...
                            <td><?php echo $record->scheduled_duetime; ?></td> 
                            <td><?php echo $record->arrival_time; ?></td>
                            <td><?php echo $record->departure_time; ?></td>
                            <td><?php if($record->start_time!=NULL) echo date('H:i',strtotime($record->start_time)-18000); ?></td>
                            <td><?php if($record->end_time!=NULL) echo date('H:i',strtotime($record->end_time)-18000); ?></td>
                            ...
                            <td><?php if(isset($statuscode[$status]))
							{
          ...
          <ul class="pagination pagination-sm justify-content-center">
            ...
            <li class='page-item <?php ($page <= 1 ? print 'disabled' : '')?>'>
              <button class='paginationbt btn btn-primary'   data-id='1'><<</button>
            </li>
            <!-- Link of the previous page -->
            <li class='page-item <?php ($page <= 1 ? print 'disabled' : '')?>'>
              <button class='paginationbt btn btn-primary'   data-id='<?php ($page>1 ? print($page-1) : print 1)?>'><</button>
            </li>
            ...
            <li class='page-item <?php
              ...
              <button class='<?php echo 'paginationbt  btn btn-primary'.$active ?>'    data-id='<?php echo $i;?>'><?php echo $i;?></button>
            </li>
            <?php } ?>
            <!-- Link of the next page -->
            <li class='page-item <?php ($page >= $total_page ? print 'disabled' : '')?>'>
              <button class='paginationbt btn btn-primary'   data-id='<?php ($page < $total_page ? print($page+1) : print $total_page)?>'>></button>
            </li>
            <!-- Link of the last page -->
            <li class='page-item <?php ($page >= $total_page ? print 'disabled' : '')?>'>
              <button class='paginationbt btn btn-primary'  data-id='<?php echo $total_page;?>'>>>                      
              </button>
            </li>
          </ul>
       <?php } ?>
