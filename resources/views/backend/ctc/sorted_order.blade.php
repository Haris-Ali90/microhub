...
@section('inlineJS')
   ...
   $( function() {
    ...
    <script>
        ...
        $(function () {
            appConfig.set('yajrabox.ajax', '{{ route('ctcSorted.data') }}');
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            ...
                            <h2>{{ $title_name }} <small>Sorter Order</small></h2>
                            @if(can_access_route('export_CTCSorted.excel',$userPermissoins))
                            <div class="excel-btn" style="float: right">
                                <a href="{{ route('export_CTCSorted.excel') }}"
