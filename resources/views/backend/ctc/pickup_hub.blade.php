...
@section('inlineJS')
   ...
   $( function() {
    ...
    <script>
        ...
        $(function () {
            appConfig.set('yajrabox.ajax', '{{ route('ctcPickedUp.data') }}');
            ...
            appConfig.set('yajrabox.columns', [
                ...
                {data: 'store_name', orderable: true, searchable: true, className: 'text-center'},
                {data: 'customers_name', orderable: true, searchable: true, className: 'text-center'},
                {data: 'address', orderable: true, searchable: true, className: 'text-center'},
                {data: 'postal_code', orderable: true, searchable: true},
                {data: 'city_name', orderable: true, searchable: true},
                {data: 'weight', orderable: true, searchable: true, className: 'text-center'},
                {data: 'pickup_from_store', orderable: true, searchable: true, className: 'text-center'},
                {data: 'at_hub_processing', orderable: true, searchable: true, className: 'text-center'},
                {data: 'out_for_delivery', orderable: true, searchable: true},
                ...
                {data: 'tracking_id_link', orderable: false, searchable: false, className: 'text-center'},
                {data: 'sprint_status', orderable: true, searchable: true},
                {data: 'notes', orderable: true, searchable: true, className: 'text-center'},
                {data: 'hubreturned2', orderable: true, searchable: true, className: 'text-center'},
                {data: 'hubpickup2', orderable: true, searchable: true, className: 'text-center'},
                {data: 'deliver2', orderable: true, searchable: true},
                {data: 'hubreturned3', orderable: true, searchable: true},
                {data: 'hubpickup3', orderable: true, searchable: true, className: 'text-center'},
                {data: 'deliver3', orderable: true, searchable: true, className: 'text-center'},
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h3 class="text-center">{{ $title_name }} Pickup Hub<small></small></h3>
                </div>
            </div>
        ...
        @include('backend.ctc.ctc_cards')
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>{{ $title_name }} <small>Pickup Hub</small></h2>
                            @if(can_access_route('export_CTCPickedUp.excel',$userPermissoins))
                            <div class="excel-btn" style="float: right">
                                <a href="{{ route('export_CTCPickedUp.excel') }}"
                    ...
                    <tr>
                                        ...
                                        <th>At Hub Processing</th>
                                        <th>Out For Delivery</th>
                                        <th>Estimated Customer delivery time</th>
                                        <th>Actual Customer delivery time</th>
                                        <th>Safe Drop image</th>
                                        <th>Shipment tracking #</th>
                                        <th>Shipment tracking link</th>
                                        <th>Shipment Delivery Status</th>
                                        <th>JoyeCo Notes / Comments</th>
                                        <th>Returned to HUB 2</th>
                                        <th>2nd Attempt Pick up</th>
                                        <th>2nd Attempt Delivery</th>
                                        <th>Returned to HUB 3</th>
                                        <th>3rd Attempt Pick up</th>
                                        <th>3rd Attempt Delivery</th>
                                        <th>Action</th>
                    </tr>
                      </thead>
                      <tbody>
