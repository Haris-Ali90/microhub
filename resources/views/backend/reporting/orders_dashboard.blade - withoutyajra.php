    ...
    <script>
        ...
        $(function () {
            ...
            appConfig.set('yajrabox.columns', [
                {data: 'id',name:'sprint__sprints.id', orderable: true, searchable: true, className: 'text-center'},
                {data: 'tracking_id',name:'merchantids.tracking_id', orderable: true, searchable: true, className: 'text-center'},
                {data: 'created_at', name:'sprint__sprints.created_at' ,orderable: true, searchable: true, className: 'text-center'},
                {data: 'updated_at',name:'sprint__sprints.updated_at',orderable: true, searchable: true, className: 'text-center'},
                {data :'sprint_status', name: 'sprint__sprints.status_id',  orderable: true, searchable: false, className: 'text-center'},
                {data :'task_status', name: 'sprint__tasks.status_id', orderable: true, searchable: false, className: 'text-center'},
//                {data: 'type', orderable: true, searchable: true,className: 'text-center'},
                {data: 'route_id', name:'joey_route_locations.route_id', orderable: true, searchable: true, className: 'text-center'},
                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_title">
                            <form  method="get" action="reporting">
                                ...
                                <input style="width: 170px;" id="fromdatepicker" type="date"
                                       name="fromdatepicker" class="data-selector" required=""
                                       value="{{ isset($_GET['fromdatepicker'])?$_GET['fromdatepicker']: date('Y-m-d') }}"
                                       placeholder="Search">
                                <label style="margin-left: 50px">To Date:</label>
                                <input style="width: 170px;" type="date" id="todatepicker"
                                       name="todatepicker" class="data-selector" required=""
                                       value="{{ isset($_GET['todatepicker'])?$_GET['todatepicker']: date('Y-m-d') }}"
                                       placeholder="Search">
                                <label style="margin-left: 50px">Select Vendor</label>
                                {!! Form::select('vendors', $vendors, null, ['class' => 'js-example-basic-multiple','style'=>'width: 170px']) !!}
