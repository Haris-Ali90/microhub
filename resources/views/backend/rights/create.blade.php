            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="">
                            <div class="row">
                                <h2 class="main-section-heading">Create Right</h2>
                            </div>
                            <div class="clearfix"></div>
                        </div>
                                                ...
                                                <!--from-input-col-open-->
                                                    <div class="col-md-3 col-sm-3 from-input-col">
                                                        <div class="form-group">
                                                            <input type="checkbox" name="{{$portal_name}}_permissions[]" class="permissions-checkbox {{$portal_name}}-permissions-checkbox"  value="{{ $permission }}" data-portal-name="{{$portal_name}}" />
