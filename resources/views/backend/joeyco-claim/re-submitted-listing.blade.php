...
@section('title', 'Re-Submitted Claims List')
...
@section('content')
    ...
    <div class="right_col" role="main">
        ...
        <div class="custom_us">
         ...
         <div class="col-lg-6">
         <h3 class="m-0">Re-Submitted Claims List</h3>
         </div>
         <div class="col-lg-6 text-right">
                        <button  type='button' onclick="exportTableToCSV('JoeyCo-Claims-ReSubmitted-List.csv')" class=' m-0  btn blue btn c-color'>Generate Report in CSV</button>
                    </div>
...
<!-- Modal -->
    ...
    <script type="text/javascript">
        $(function () {
            appConfig.set('yajrabox.ajax', '{{ route('claims.reSubmittedList-data') }}');
