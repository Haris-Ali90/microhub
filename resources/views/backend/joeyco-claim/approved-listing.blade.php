...
@section('title', 'Approved Claims List')
...
@section('content')
    ...
    <div class="right_col" role="main">
        ...
        <div class="custom_us">
           ...
           <div class="col-lg-6">
           <h3>Approved Claims List </h3>
           </div>
           <div class="col-lg-6 text-right">
                        <button  type='button' onclick="exportTableToCSV('JoeyCo-Claims-Approved-List.csv')"  class='btn blue btn green-gradient' style="margin:0px !important;">Generate Report in CSV</button>
                    </div>
...
<table class="table table-striped table-bordered table-hover yajrabox" id="sample_1">
    ...
    <script type="text/javascript">
        $(function () {
            appConfig.set('yajrabox.ajax', '{{ route('claims.approvedList-data') }}');
