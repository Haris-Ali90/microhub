...
@section('title', 'Not Approved Claims List')
        ...
        <div class="custom_us">
            ...
            @endif
                ...
                <div class="portlet box blue margin-tops">
                    ...
                    <div class="col-lg-6">
                    <h3>Not Approved Claims List </h3>
                    </div>
                    <div class="col-lg-6 text-right">
                        <button  type='button' onclick="exportTableToCSV('JoeyCo-Claims-Not-Approved-List.csv')"  class='btn blue btn green-gradient' style="margin:0 !important">Generate Report in CSV</button>
                    </div>
...
<table class="table table-striped table-bordered table-hover yajrabox" id="sample_1">
    <thead>
    <tr>
        <th  class="text-center ">Tracking Id / Merchant No</th>
                ...
                <div id="openStatusChangeModal" class="modal fade" role="dialog">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <form  id="submitForm" method="post" action="{{route('claims.uploadImage')}}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="modal-footer">
                                    <button type="button" onclick="uploadImageBtn('claims/status-upload-image')" class="btn btn-primary">Update Status</button>
...
<script type="text/javascript">
    ...
    $(function () {
        appConfig.set('yajrabox.ajax', '{{ route('claims.notApprovedList-data') }}');
