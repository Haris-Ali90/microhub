...
@section('title', 'Borderless Statistics')
...
@section('inlineJS')
    ...
    <script>
        ...
        function getInProgressOrdersData() {
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo URL::to('/'); ?>/borderless/inprogress/" + selected_date + "/" + type,
                data: {},
                success: function (data) {
        ...
        function getCustomRouteData() {
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo URL::to('/'); ?>/borderless/customroutecards/" + selected_date,
                data: {},
                success: function (data) {
        ...
        function getYesterdayOrderData() {
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo URL::to('/'); ?>/borderless/yesterdaycards/" + selected_date,
                data: {},
                success: function (data) {
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left amazon-text">
                    <h3 class="text-center">Borderless Statistics
                        <small></small>
                    </h3>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>
                                <small>Borderless Statistics</small>
                            </h2>
