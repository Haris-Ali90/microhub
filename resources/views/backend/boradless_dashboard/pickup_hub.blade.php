...
@section('title', 'Borderless Dashboard')
...
@section('inlineJS')
    ...
    <script>
        ...
        $(function () {
            appConfig.set('yajrabox.ajax', '{{ route('new-pickup-borderless.data') }}');
        ...
        function getTotalOrderData() {
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo URL::to('/'); ?>/borderless/totalcards/" + selected_date + "/" + type,
                data: {},
        ...
        @include('backend.boradless_dashboard.boradless_cards')
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>{{ $title_name }} <small>Out For Delivery</small></h2>
                            @if(can_access_route('new-pickup-borderless-export.excel',$userPermissoins))
                            <div class="excel-btn" style="float: right">
                                <a href="{{ route('new-pickup-borderless-export.excel') }}"
