...
@section('inlineJS')
    ...
    <script>
        ...
        $(function () {
            appConfig.set('yajrabox.ajax', '{{ route('new-sort-borderless.data') }}');
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            ...
                            <h2>{{ $title_name }} <small>Sorted Order</small></h2>
                            @if(can_access_route('new-sort-borderless-export.excel',$userPermissoins))
                            <div class="excel-btn" style="float: right">
                                <a href="{{ route('new-sort-borderless-export.excel') }}"
