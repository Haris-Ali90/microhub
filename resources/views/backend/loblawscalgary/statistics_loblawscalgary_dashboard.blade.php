...
@section('title', 'Loblaws Calgary Dashboard')
                    ...
                    <div class="x_title col-md-12">
                        <form method="get" action="">
                            ...
                            <h2>Loblaws <small>Loblaws Calgary Dashboard</small></h2>
							 <div  class=" text-right"><button  target="_blank" onclick="exportTableToCSV('loblaws-calgary-reprt-<?php echo $date ?>.csv')"  class="btn btn-success pl-md-3">Export CSV</button></div>
                            <div class="clearfix"></div>
                        </div>
