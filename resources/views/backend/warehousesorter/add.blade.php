...
@section('title', 'Warehouse Setting')
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_title">
                            <h2>Warehouse Setting <small>Add New Warehouse Setting</small></h2>
                        ...
                        {!! Form::open( ['url' => ['warehouse/sorter/create'], 'files'=> true , 'method' => 'POST', 'class' => 'form-horizontal form-label-left', 'role' => 'form']) !!}
