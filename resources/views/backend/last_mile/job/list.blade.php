                        ...
                        <div class="x_content">
                            ...
                            <div class="table-responsive">
                                <table id="datatable" class="table table-striped table-bordered">
                                    ...
                                    @else
                                        {{--*/ $i = 1 /*--}}
                                        @foreach( $lastMileJobs as $record )
                                            <tr class="">
                                                <td>{{ $i }}</td>
                                                <td>{{ $record->job_id }}</td>
        ...
        $(function () {
            $(".createRouteByJobId").click(function () {
                ...
                if(routeEngine != ''){
                    ...
                    $('#ex6').modal('hide');
                    // var url = ''
                    // if(routeEngine == 3){ // engine 1 is routific
                    //     url = '../create/'+jobId+'/route';
                    // }else if(routeEngine == 2){ // engine 2 is beta routific
                    //     url = '../../../beta/ctc/createCustom/'+jobId+'/route';
