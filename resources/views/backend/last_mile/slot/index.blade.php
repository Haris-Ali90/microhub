...
@section('content')
    ...
    <div id="ex1" class="modal" style="display: none">
        <div class='modal-dialog'>
            <div class='modal-content'>
                ...
                <form action="{{URL::to('last/mile/slot/create')}}" method="post">
    ...
    <div id="ex2" class="modal" style="display: none">
        <div class='modal-dialog'>
            <div class='modal-content'>
                ...
                <form action="{{URL::to('last/mile/slot/update')}}" method="post">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    <div class="form-group">
    ...
    <div id="ex4" class="modal" style="display: none">
        <div class='modal-dialog'>
            ...
            <div class='modal-content'>
                ...
                <form action="{{URL::to('/last/mile/slot/delete')}}" method="post">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
    ...
    <script type="text/javascript">
        // get last mile slot detail information popup
        $(document).ready(function () {
            $(".details").click(function () {
                ...
                $.ajax({
                    type: "GET",
                    url: b_url + '/last/mile/slot/' + del_id + '/detail',
        ...
        // get update last mile detail in modal
        $(document).ready(function () {
            $(".update").click(function () {
                ...
                $.ajax({
                    type: "GET",
                    url: b_url + '/last/mile/slot/' + del_id,
                    success: function (data) {
                        a = JSON.parse(data);
                        console.log(a);
