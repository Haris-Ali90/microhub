...
@section('title', 'New Loblaws Calgary Dashboard')
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left amazon-text">
                    <h3 class="text-center">Loblaws Calgary Dashboard<small></small></h3>
                </div>
            </div>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="x_title col-md-12">
                        <form method="get" action="">
                            ...
                            <h2>Loblaws <small>Loblaws Calgary Dashboard</small></h2>
							 <div  class=" text-right">
                                <button  onclick="loblawsrefresh()"  class="btn btn-success pl-md-3 refresh" style="display: none">Refresh</button>
                                 <button  target="_blank" onclick="exportTableToCSV('loblaws-calgary-reprt-<?php echo $date ?>.csv')"  class="btn btn-success pl-md-3">Export CSV</button>
                        ...
                        <div class="col-sm-12 loblaws-statistics-dashboard-btn-warp">
                            ...
                            <div class="col-sm-2 loblaws-statistics-checkbox-wrap">
                                ...
                                <input class="form-control loblaws-statistics-checkbox" type="checkbox"  data-status="false" data-for="loblawscalgary-otd" data-targeted-div="otd-main-wrap" />
                                <div class="icon">
                        <i class="fa fa-pie-chart" style=" font-size: x-large;color: #e36d28;"></i>
                            ...
                            <div class="col-sm-2 loblaws-statistics-checkbox-wrap">
                                ...
                                <input class="form-control loblaws-statistics-checkbox" type="checkbox"  data-status="false" data-for="loblawscalgary-orders" data-targeted-div="loblaws-orders-main-wrap"/>
                                <div class="icon">
                        <i class="fa fa-cubes" style=" font-size: x-large;color: #e36d28;"></i>
                            ...
                            <div class="col-sm-2 loblaws-statistics-checkbox-wrap">
                                ...
                                <input class="form-control loblaws-statistics-checkbox" type="checkbox"  data-status="false" data-for="loblawscalgary-ota" data-targeted-div="lablaws-ota-main-wrap"/>
                                <div class="icon">
                 ...
                 <div class="col-md-12 loblaws-statistics-show-box-main-wrap otd-main-wrap otd-overall-exprince-main-wrap">
                  ...
                  <div class="statistics-ajax-data-loader-wrap ">
                    ...
                    <div class="col-md-12 loblaws-statistics-show-box-inner-wrap">
                        ...
                        <!--loblaws-statistics-show-box-heading-wrap-open-->
                        <div class="col-md-12 loblaws-statistics-show-box-data-wrap loblawscalgary-otd">
               ...
               <div class="col-md-12 loblaws-statistics-show-box-main-wrap loblaws-orders-main-wrap">
                  ...
                  <div class="statistics-ajax-data-loader-wrap ">
                    ...
                    <div class="col-md-12 loblaws-statistics-show-box-inner-wrap">
                        <!--loblaws-statistics-show-box-heading-wrap-open-->
                        <div class="col-md-12 loblaws-statistics-show-box-heading-wrap">
                            <h2>Loblaws Calgary Orders </h2>
                        </div>
                        <!--loblaws-statistics-show-box-heading-wrap-close-->

                        <!--loblaws-statistics-show-box-heading-wrap-open-->
                        <div class="col-md-12 loblaws-statistics-show-box-data-wrap loblawscalgary-orders">
                ...
                <div class="col-md-12 loblaws-statistics-show-box-main-wrap lablaws-ota-main-wrap">
                  ...
                  <div class="statistics-ajax-data-loader-wrap ">
                    ...
                    <div class="col-md-12 loblaws-statistics-show-box-inner-wrap">
                        ...
                        <!--loblaws-statistics-show-box-heading-wrap-open-->
                        <div class="col-md-12 loblaws-statistics-show-box-data-wrap loblawscalgary-ota">
...
@section('inlineJS')
    <script>
        ...
        $(document).ready(function () {
            ...
            setInterval(function () {
                ...
                if(CurretnDate == Selectdate) {
                    $.ajax({
                        type: "get",
                        url: '{{ URL::to('loblawscalgary/new-count')}}',
                        data: {},
                        success: function (data) {
                            if (data >= 1) {
                                $('#notify').val(data);
                                toast.success('' + data + ' New Loblaws Calgary Order Created');
                            }
                        }
                    });
                }
        ...
        function loblawsrefresh() {
            ...
            var url_for = 'loblawscalgary-orders';
            var status = 'false';
...
function timerIncrement() {
    ...
    if (idleTime > 5) { // 5 minutes
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                let el = $('.loblaws-statistics-checkbox');
                var url_for = 'loblawscalgary-orders';//el.attr('data-for');
      ...
      $('.loblaws-statistics-checkbox').click(function () {
          ...
          var s=status.localeCompare('false');
            ...
            {
                if (url_for == 'loblawscalgary-orders'){
                    $('.refresh').show();
                }
                $('.'+url_for).show();
              ...
              success: function (data) {
                ...
                $('.'+targeted_div).find('.statistics-ajax-data-loader-wrap').removeClass('show');
                  if(data.status = true)
                  {
                      ...
                      else if(data['for'] == 'loblawscalgary-ota')
                      {
    ...
    function show_loblaws_otd_bar_chart_one(data) {
        ...
        Highcharts.chart('loblawscalgary-orders',{
            chart: {
                type: 'column'
            },
            title: {
      ...
      $(document).on('click','.paginationbt',function(){
        ...
        $.ajax({
              type: "get",
              url: "{{ URL::to('dashboard/statistics/ajax/loblawscalgary-orders')}}",
