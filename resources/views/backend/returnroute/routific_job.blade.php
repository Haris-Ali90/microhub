        ...
        <div class="">
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                        <form id="filter"  style="padding: 10px 0;" action="<?php echo "../../returnroutific/".$id."/job"?>" method="get">
                            <div class="row">
                                <div class="col-md-3">
...
$(function() {
    $(".createCustom").click(function(){
        ...
        document.getElementById('main_form').innerHTML ="<div class='modal-content'><div class='modal-header'>" +
            ...
            "<form action='../../returncreateCustom/"+del_id+"/route' method='get'><div class='form-group'><p><b>Are you sure you want to pull these routes?</b></p></div>" +
