                    ...
                    buttons: {
                        'confirm': {
                            ...
                            action: function () {
                                ...
                                var hub_id = <?php Auth::user();?>
                                $.ajax({
                                    type: "GET",
                                    url: '../hub/'+hub_id+'/re-route/'+id,
...
@section('content')
    ...
    <div class="right_col" role="main">
        <div class="">
            ...
            <div class="page-title">
                <div class="title_left amazon-text">
                    <h3>{{getHubTitle()}} Return Routes<small></small></h3>
                </div>
            </div>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <form id="filter" action="" method="get">
                            <div class="row">
                                <div class="col-md-3">
                                    <input id="date" name="date" type="date" placeholder="date" value="<?php echo $date ?>"  class="form-control1">
                                </div>
                                <div class="col-md-3">
     ...
     <a class=' orange-gradient btn' target='_blank' href='../returnroute/" . $counts[$j]->route_id . "/edit/hub/17' title='Edit Route'>E</a>
                ...
                <form action="routes/add" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <select id="zone" multiple class="form-control chosen-select" name="zone[]" requried style="width: 100%;">
                            ...
                            $user = Auth::user();
                            $hub_id = $user->hub_id;
                            $zones =  RoutingZones::where('hub_id','=',$hub_id)->whereNull('deleted_at')->get();
    ...
    <div id="transfer" class="modal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-body">
            <div class='modal-dialog'>
                <div class='modal-content'>
                    <p><strong class="order-id green"></strong></p>
                    <form action='../returnroute/transfer/hub' method="POST">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
    ...
    <script>
        ...
        function fullmap() {
            ...
            $.ajax({
                ...
                url : '../../allroute/0/location/joey?date=<?php echo $date; ?>',
                type : 'GET',
                dataType:'json',
    ...
    <script>
        ...
        $(document).on('click', '.details', function(e) {
            ...
            $.ajax({
                ...
                url: '../returnroute/' +  routeId + '/details',
                type: 'GET',
                dataType: 'json',
                success: function(data) {
                    var i = 0;
