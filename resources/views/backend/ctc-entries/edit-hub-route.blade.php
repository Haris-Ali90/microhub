...
@section('title', 'Last Mile Route Hub ')
  ...
  <script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script> -->
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left amazon-text">
                    <h3 class=""> Route Detail<small></small></h3>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Last Mile <small>Route Detail</small></h2>
                            <div class="clearfix"></div>
                        </div>
    ...
    <script>
        function showAddNoteModal(t_id,r_id) {
            ...
            $.ajax({
                type:'GET',
                url:'{{route("new-ctc-route-info.getNotes")}}',
        ...
        function sendNote() {
            if($('#myNotesModal #note').val()==''){
                ...
                $.ajax({
                    type:'POST',
                    url:'{{route("new-ctc-route-info.addNote")}}',
                    data: formData,
                    // contentType: false,
                    // processData: false,
                    success: function (res) {
