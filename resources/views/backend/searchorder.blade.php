                            ...
                            <?php
                               ...
                               foreach ($data as $response){
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo date('Y-m-d H:i:s',strtotime($response->created_at)-14400); ?></td>
                                        <td>

                                            @if(can_access_route('update-order.update',$userPermissoins))
                                     ...
                                     foreach($status as $key => $oc){ ?>
                                      ...
                                      <a class="Status btn orange-gradient btn-xs"  data-id='<?php echo $response->tracking_id; ?>'>Update Status</a>
                                            @endif
                                                @if(can_access_route('searchorder.show',$userPermissoins))
