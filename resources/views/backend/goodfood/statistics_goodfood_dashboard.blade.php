...
@section('title', 'Good Food Dashboard')
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left amazon-text">
                    <h3 class="text-center">Good Food Dashboard<small></small></h3>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title col-md-12">
                            ...
                            <h2>Good Food <small>Good Food Dashboard</small></h2>
                            <div  class="text-right">
                                <button  onclick="loblawsrefresh()"  class="btn btn-success pl-md-3 refresh" style="display: none">Refresh</button>
                                <button  target="_blank" onclick="exportTableToCSV('good-food-reprt-<?php echo $date ?>.csv')"  class="btn btn-success pl-md-3">Export CSV</button></div>
                            <div class="clearfix"></div>
                        </div>
                        ...
                        <div class="col-sm-12 loblaws-statistics-dashboard-btn-warp">
                            ...
                            <div class="col-sm-2 loblaws-statistics-checkbox-wrap">
                                ...
                                <input class="form-control loblaws-statistics-checkbox" type="checkbox"  data-status="false" data-for="good-food-otd" data-targeted-div="otd-main-wrap" />
                                <div class="icon">
                            ...
                            <div class="col-sm-2 loblaws-statistics-checkbox-wrap">
                                ...
                                <input class="form-control loblaws-statistics-checkbox" type="checkbox"  data-status="false" data-for="good-food-orders" data-targeted-div="loblaws-orders-main-wrap"/>
                                <div class="icon">
                            ...
                            <div class="col-sm-2 loblaws-statistics-checkbox-wrap">
                                ...
                                <input class="form-control loblaws-statistics-checkbox" type="checkbox"  data-status="false" data-for="good-food-ota" data-targeted-div="lablaws-ota-main-wrap"/>
                                <div class="icon">
                ...
                <div class="col-md-12 loblaws-statistics-show-box-main-wrap loblaws-orders-main-wrap ">
                    ...
                    <div class="col-md-12 loblaws-statistics-show-box-inner-wrap">
                        <!--loblaws-statistics-show-box-heading-wrap-open-->
                        <div class="col-md-12 loblaws-statistics-show-box-heading-wrap">
                            <h2>Good Food Orders </h2>
                        </div>
                        <!--loblaws-statistics-show-box-heading-wrap-close-->

                        <!--loblaws-statistics-show-box-heading-wrap-open-->
                        <div class="col-md-12 loblaws-statistics-show-box-data-wrap  good-food-orders">
        ...
        $(document).ready(function () {
            ...
            setInterval(function () {
                ...
                if(CurretnDate == Selectdate) {
                    $.ajax({
                        type: "get",
                        url: '{{ URL::to('good-food/new-count')}}',
                        data: {},
                        success: function (data) {
                            if (data >= 1) {
                                $('#notify').val(data);
                                toast.success('' + data + ' Good Food Order Created');
                            }
                        }
                    });
                }
            ...
            if (idleTime > 5) { // 5 minutes
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        let el = $('.loblaws-statistics-checkbox');
                        var url_for = 'good-food-orders';//el.attr('data-for');
...
*/
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if(data.status = true)
                    {
                        ...
                        else if(data['for'] == 'good-food-ota')
                        {
        ...
        $(document).on('click','.paginationbt',function(){
            ...
            $.ajax({
                type: "get",
                url: "{{ URL::to('dashboard/statistics/ajax/good-food-orders')}}",
