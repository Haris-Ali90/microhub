...
@section('title', 'Generate Good Food Orders Report')
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left amazon-text">
                    <h3 class="text-center">Generate Good Food Orders Report
                        <small></small>
                    </h3>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2 class="float-none white-space-normal">Generate Good Food Orders Report
                                <small></small>
                            </h2>
                        ...
                        <div class="x_title">
                            <form method="get" action="{{route('generate-goodfood-report-csv')}}">
                                <div class="row">
                                    <div class="col-md-3">
