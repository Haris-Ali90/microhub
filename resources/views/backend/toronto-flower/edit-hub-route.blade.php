...
@section('title', 'Toronto Flower Route Hub ')
           ...
           {{-- <button class="transfer-but transfer btn orange-gradient" disabled>Transfer</button>--}}
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Toronto Flower <small>Route Detail</small></h2>
                            <div class="clearfix"></div>
                        </div>
             ...
             foreach($route as $routeLoc) {
                   ...
                   /* echo "<td><input class='check' id='check' type='checkbox' name='check' value='".$routeLoc->id."'></td>";*/
                    ...
                    echo "<td>"?>
                      @if(can_access_route('toronto_flower_info_route.detail',$userPermissoins))
                    <a href="{{backend_url('toronto/flower/route/orders/trackingid/'.$routeLoc->sprint_id.'/details')}}" target='_blank' class='btn btn-warning btn-xs'>Detail</a>
                      @endif
                      <?php echo "</td>";
                    echo "</tr>";
                    $i++;
