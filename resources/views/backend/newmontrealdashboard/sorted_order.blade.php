...
@section('inlineJS')
    ...
    <script>
        ...
        $(function () {
            appConfig.set('yajrabox.ajax', '{{ route('newmontrealSorted.data') }}');
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h3 class="text-center">{{ getHubTitle() }} Sorted Order<small></small></h3>
                </div>
            </div>
                            ...
                            <form method="get" action="">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 sm_custm" style="padding-top: 25px">
                                        @if(can_access_route('newexport_MontrealSorted.excel',$userPermissoins))
                                            <div class="excel-btn" style="float: right">
                                                <a href="{{ route('newexport_MontrealSorted.excel') }}"
