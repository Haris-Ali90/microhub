    ...
    @if(in_array($type, ['all','return']))
        <!--Animated-c Div Open-->
            <div class="animated flipInY col-lg-3 col-md-6 col-sm-12 dashbords-conts-tiles-main-wrap">
                ...
                <!--dashbords-conts-tiles-loader-main-wrap-close-->
                <a href="<?php echo URL::to('/'); ?>/reporting/returned?datepicker=<?php echo isset($_GET['datepicker'])?$_GET['datepicker']: date('Y-m-d');?>&type=return">
                <div class="tile-stats">
                    <div class="icon">
        ...
        @if(in_array($type, ['return']))
            ...
            <div class="animated flipInY col-lg-3 col-md-6 col-sm-12 dashbords-conts-tiles-main-wrap">
                ...
                <!--dashbords-conts-tiles-loader-main-wrap-close-->
                <a href="<?php echo URL::to('/'); ?>/reporting/returned-not-hub?datepicker=<?php echo isset($_GET['datepicker'])?$_GET['datepicker']: date('Y-m-d');?>&type=return">
                <div class="tile-stats">
                    <div class="icon">
                        <i class="fa fa-rotate-left"></i>
                    </div>
        ...
        <!--Animated-d Div Open-->
            <div class="animated flipInY col-lg-3 col-md-6 col-sm-12 dashbords-conts-tiles-main-wrap">
                ...
                <!--dashbords-conts-tiles-loader-main-wrap-close-->
                <a href="<?php echo URL::to('/'); ?>/reporting/sorted?datepicker=<?php echo isset($_GET['datepicker'])?$_GET['datepicker']: date('Y-m-d');?>&type=sorted">
                <div class="tile-stats">
                    <div class="icon">
                        <i class="fa fa-sort-amount-asc"></i>
                    </div>
                    <div class="count" id="sorted_orders">0
                    </div>{{--{{ isset($amazon_count)?$amazon_count['sorted']:0 }}</div>--}}
        ...
        <!--Animated-e Div Open-->
            <div class="animated flipInY col-lg-3 col-md-6 col-sm-12 dashbords-conts-tiles-main-wrap">
                ...
                <!--dashbords-conts-tiles-loader-main-wrap-close-->
                <a href="<?php echo URL::to('/'); ?>/reporting/picked/up?datepicker=<?php echo isset($_GET['datepicker'])?$_GET['datepicker']: date('Y-m-d');?>&type=picked">
                <div class="tile-stats">
                    <div class="icon">
                        <i class="fa fa-car"></i>
                    </div>
                    <div class="count" id="picked_orders">0
                    </div>{{--{{ isset($amazon_count)?$amazon_count['pickup']:0 }}</div>--}}
        ...
        <!--Animated-f Div Open-->
            <div class="animated flipInY col-lg-3 col-md-6 col-sm-12 dashbords-conts-tiles-main-wrap">
                ...
                <!--dashbords-conts-tiles-loader-main-wrap-close-->
                <a href="<?php echo URL::to('/'); ?>/reporting/delivered?datepicker=<?php echo isset($_GET['datepicker'])?$_GET['datepicker']: date('Y-m-d');?>&type=delivered">
                <div class="tile-stats">
                    <div class="icon">
                        <i class="fa fa-cube"></i>
                    </div>
                    <div class="count" id="delivered_orders">0
                    </div>{{--{{ isset($amazon_count)?$amazon_count['delivered_order']:0 }}</div>--}}
        ...
        <!--Animated-g Div Open-->
            <div class="animated flipInY col-lg-3 col-md-6 col-sm-12 dashbords-conts-tiles-main-wrap">
                ...
                <!--dashbords-conts-tiles-loader-main-wrap-close-->
                <a href="<?php echo URL::to('/'); ?>/reporting/not/scan?datepicker=<?php echo isset($_GET['datepicker'])?$_GET['datepicker']: date('Y-m-d');?>&type=scan">
                <div class="tile-stats">
                    <div class="icon">
                        <i class="fa fa-calendar"></i>
                    </div>
                    <div class="count" id="notscan_orders">0
                    </div>{{--{{ isset($amazon_count)?$amazon_count['notscan']:0  }}</div>--}}
        ...
        <!--Animated-h Div Open-->
            <div class="animated flipInY col-lg-3 col-md-6 col-sm-12 dashbords-conts-tiles-main-wrap">
                ...
                <!--dashbords-conts-tiles-loader-main-wrap-close-->
                <a href="<?php echo URL::to('/'); ?>/reporting/custom-route?datepicker=<?php echo isset($_GET['datepicker'])?$_GET['datepicker']: date('Y-m-d');?>&type=custom">
                <div class="tile-stats">
                    <div class="icon">
                        <i class="fa fa-cube"></i>
                    </div>
                    <div class="count" id="custom_orders">0
                    </div>{{--{{ isset($amazon_count)?$amazon_count['custom_route']:0 }}</div>--}}
