...
@section('inlineJS')
    ...
    <script>
        ...
        $(function () {
            appConfig.set('yajrabox.ajax', '{{ route('newmontrealNotReturned.data') }}');
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h3 class="text-center">{{ getHubTitle() }} Returns Not Received At Hub<small></small></h3>
                </div>
            </div>
        ...
        @include('backend.newmontrealdashboard.montreal_cards')
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>{{ getHubTitle() }} <small>Returns Not Received At Hub</small></h2>
                            @if(can_access_route('newexport_MontrealNotReturned.excel',$userPermissoins))
                            <div class="excel-btn" style="float: right">
                                <a href="{{ route('newexport_MontrealNotReturned.excel') }}"
                                   class="btn buttons-excel buttons-html5 btn-sm btn-primary excelstyleclass">
                                    Export to Excel
                                </a>
                            </div>
                            @endif
                            @if(can_access_route('newexport_MontrealNotReturned_Tracking.excel',$userPermissoins))
                                <div class="excel-btn" style="float: right">
                                    <a href="{{ route('newexport_MontrealNotReturned_Tracking.excel') }}"
                                       class="btn buttons-excel buttons-html5 btn-sm btn-primary excelstyleclass">
