...
@section('inlineJS')
   ...
   $( function() {
    ...
    <script>
        ...
        $(function () {
            appConfig.set('yajrabox.ajax', '{{ route('ottawaNotScan.data') }}');
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            ...
                            @if(can_access_route('export_OttawaNotScan.excel',$userPermissoins))
                            <div class="excel-btn" style="float: right">
                                <a href="{{ route('export_OttawaNotScan.excel') }}"
