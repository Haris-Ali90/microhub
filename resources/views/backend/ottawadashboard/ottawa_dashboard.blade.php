...
<script>
    ...
    $(function () {
        appConfig.set('yajrabox.ajax', '{{ route('ottawa.data') }}');
        ...
        @include('backend.ottawadashboard.ottawa_cards')
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Amazon Ottawa <small>Ottawa Dashboard</small></h2>
                            @if(can_access_route('export_Ottawa.excel',$userPermissoins))
                            <div class="excel-btn" style="float: right">
                                <a href="{{ route('export_Ottawa.excel') }}"
