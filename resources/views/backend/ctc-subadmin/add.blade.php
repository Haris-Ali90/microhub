...
@section('content')
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_title">
                            <h2>CTC Sub Admin <small>Add New CTC Sub Admin</small></h2>
                        ...
                        {!! Form::open( ['url' => ['ctc/subadmin/create'], 'files'=> true , 'method' => 'POST', 'class' => 'form-horizontal form-label-left', 'role' => 'form']) !!}
                        @include( 'backend.ctc-subadmin.form' )
                        {!! Form::close() !!}
                    </div>
                </div>
            </div>
    ...
    {{--<div class="row">
        <div class="col-lg-6">
            {!! Form::model($user, ['url' => ['backend/subadmin', $user->id], 'method' => 'PUT', 'class' => '', 'role' => 'form']) !!}
