                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="x_title col-md-12">
                        <form method="get" action="">
							...
							<div  class="text-right"><button  target="_blank" onclick="exportTableToCSV('loblaws-home-delivery-reprt-<?php echo $date ?>.csv')"  class="btn btn-success pl-md-3">Export CSV</button></div>
                            <div class="clearfix"></div>
                        </div>
