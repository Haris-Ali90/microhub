                ...
                <tbody>
                    ...
                    foreach($fullrecord as $record) {
                        ...
                        <tr>
                            ...
                            if( $record->end_time!=NULL && date('H:i:s',strtotime($record->end_time)+900) < date('H:i:s',strtotime($record->delivery_time)))
                            ...
                            <td><?php if($record->end_time!=NULL) echo date('H:i',strtotime($record->end_time)-7200)?></td>
