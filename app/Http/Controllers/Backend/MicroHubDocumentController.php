...
class MicroHubDocumentController extends BackendController
{
    ...
    public function document()
    {
        ...
        return backend_view('profile.document', compact('documents','documentTypes'));
    ...
    public function addDocument(Request $request)
    {
        ...
        if (!empty($input['documentIds'])) {
            ...
            return redirect()
            ->back()
            ->with('message', 'Document has been update successfully');
    }
