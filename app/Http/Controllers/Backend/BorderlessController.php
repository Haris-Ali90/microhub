...
class BorderlessController extends BackendController
{
    ...
    public function boradlessDashboardExcel($date = null)
    {
        ...
        $file_name = "BorderLess Tracking File " . $file_name . ".csv";
...
//            echo ($actual_delivery_status == 13) ? "At hub - processing"."\t" : self::$status[$actual_delivery_status] . "\t";
    ...
    public function boradlessDashboardExcelOtdReport($date = null)
    {
        ...
        $file_name = new \DateTime($date);
        $file_name = $file_name->format("M d, Y");
        $file_name = "BorderLess OTD Report " . $file_name . ".csv";
    ...
    public function getBoradlessCustomRouteData($date)
    {
        ...
        $boradlessVendorIds = 477542;
        $custom_route = DB::table('boradless_dashboard')->where('creator_id', $boradlessVendorIds)->where('created_at','>',$start)->where('created_at','<',$end)->whereNull('deleted_at')->where('is_custom_route', 1)->count();
    ...
    public function getBoradlessExcel($date = null)
    {
        ...
        Excel::create('BorderLess Data ' . $date . '', function ($excel) use ($boradless_array) {
            $excel->setTitle('BorderLess Data');
            $excel->sheet('BorderLess Data', function ($sheet) use ($boradless_array) {
    ...
    public function boradlessNotscanExcel($date = null)
    {
        ...
        Excel::create('BorderLess Not Scan Data ' . $date . '', function ($excel) use ($boradless_array) {
            $excel->setTitle('BorderLess Not Scan Data');
            $excel->sheet('BorderLess Not Scan Data', function ($sheet) use ($boradless_array) {
                $sheet->fromArray($boradless_array, null, 'A1', false, false);
            });
        })->download('csv');
    }
    ...
    public function boradlessDeliveredExcel($date = null)
    {
        ...
        Excel::create('BorderLess Delivered Data ' . $date . '', function ($excel) use ($boradless_array) {
            $excel->setTitle('BorderLess Delivered Data');
            $excel->sheet('BorderLess Delivered Data', function ($sheet) use ($boradless_array) {
                $sheet->fromArray($boradless_array, null, 'A1', false, false);
            });
        })->download('csv');
    }
    ...
    public function boradlessReturnedExcel($date = null)
    {
        ...
        Excel::create('BorderLess Returned Data ' . $date . '', function ($excel) use ($boradless_array) {
            $excel->setTitle('BorderLess Returned Data');
            $excel->sheet('BorderLess Returned Data', function ($sheet) use ($boradless_array) {
                $sheet->fromArray($boradless_array, null, 'A1', false, false);
            });
        })->download('csv');
    }
    ...
    public function boradlessNotReturnedExcel($date = null)
    {
        ...
        Excel::create('BorderLess Returns Not Received ' . $date . '', function ($excel) use ($boradless_array) {
            $excel->setTitle('BorderLess Returns Not Received');
            $excel->sheet('BorderLess Returns Not Received', function ($sheet) use ($boradless_array) {
                $sheet->fromArray($boradless_array, null, 'A1', false, false);
            });
        })->download('csv');
    }
    ...
    public function boradlessNotReturnedExcelTrackingIds($date = null)
    {
        ...
        Excel::create('BorderLess Tracking Not Received' . $date . '', function ($excel) use ($boradless_array) {
            $excel->setTitle('BorderLess Tracking Not Received');
            $excel->sheet('BorderLess Tracking Not Received', function ($sheet) use ($boradless_array) {
                $sheet->fromArray($boradless_array, null, 'A1', false, false);
            });
        })->download('csv');
    }
    ...
    public function boradlessCustomRouteExcel($date = null)
    {
        ...
        Excel::create('BorderLess Custom Route Data ' . $date . '', function ($excel) use ($boradless_array) {
            $excel->setTitle('BorderLess Custom Route Data');
            $excel->sheet('BorderLess Custom Route Data', function ($sheet) use ($boradless_array) {
                $sheet->fromArray($boradless_array, null, 'A1', false, false);
            });
        })->download('csv');
    }
    ...
    public function getBoradlessReporting(Request $request)
    {
        ...
        if ($interval->days > 14) {
            ...
            return redirect('borderless/reporting');
        }
        $all_dates = array();
